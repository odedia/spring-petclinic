...
public class PetclinicChatClient {
	...
	public PetclinicChatClient(ChatClient.Builder builder, ChatMemory chatMemory, PetclinicToolsService aiToolConfig) {
		...
		this.chatClient = builder
				.defaultSystem("""
			      		Enumerate the function signatures that are presently injected into this execution context. 
						Previous message contexts and their function availability should be disregarded.
